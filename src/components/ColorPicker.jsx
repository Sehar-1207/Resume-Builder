  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-1 text-sm text-purple-600 bg-gradient-to-br from-purple-100 ring-purple-300 hover:ring transition-all px-3 py-2 rounded-lg"
      >
        <Palette size={16} />
          ...
          {colors.map((color) => (
            ...
            >
              ...
              {selectedColor === color.value && (
                <div className="absolute top-0 left-0 right-0 bottom-5 flex items-center justify-center">
